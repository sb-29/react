...
function hashCompareWithLengthCheck( string memory _fileHash) public payable {
     string memory b = "Qmep96bgCmHYLbg3mDjkmXy2ioovZhf4AsQsS9XhrZ4TVM";

      require (keccak256(abi. encodePacked(b)) == keccak256(abi. encodePacked(_fileHash)) ) ;
      {
          revert();
      }
